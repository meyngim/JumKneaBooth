                ...
                <div className="space-y-1">
                    <div className="flex items-center gap-2.5">
                        ...
                        {passkey.authenticator && (
                            <span className="inline-flex items-center gap-1 rounded-md bg-surface-elevated px-2 py-0.5 text-[11px] font-medium tracking-wide text-muted uppercase ring-1 ring-border ring-inset">
                                {passkey.authenticator}
                            </span>
                        )}
                    </div>
